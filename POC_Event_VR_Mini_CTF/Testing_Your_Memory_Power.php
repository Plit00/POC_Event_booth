...
$query = $mysqli->query("SELECT * FROM `Problem` WHERE `problem_id`=1") or die($mysqli-error);
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-7">
          <a href="#">
            <img class="img-fluid rounded mb-3 mb-md-0" src="./image/beat.png" alt="">
          </a>
        </div>
        <div class="col-md-5">
          <h3>Testing Your Memory Power</h3>
          <p>Beat Saber is a top of VR games for fun.
             In the mood for Jedi, try to cut out the letters that come out in sequence.
             However, the combination of these letters is a flag.
             A very long flag will test your memory power °˖✧◝(⁰▿⁰)◜✧˖°</p>
