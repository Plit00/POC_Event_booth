...
$query = $mysqli->query("SELECT * FROM `Problem` WHERE `problem_id`=3") or die($mysqli-error);
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-7">
        <a href="#">
          <img class="img-fluid rounded mb-3 mb-md-0" src="./image/boss.png" alt="">
        </a>
      </div>
      <div class="col-md-5">
        <h3>INFINITE Boss</h3>
        <p>Manipulate the drone with the controller to shoot down the enemies and boss!
        If you shoot down the boss, we'll get the flag ^(#｀∀´)_Ψ</p>
